...
function PatientRecords() {
  ...
  }, [email, fetchPatientRecords, fetchPatientAppointments]);

  // ... rest of your JSX remains exactly the same
  // (getStatusBadgeClass, formatDate, return statement unchanged)
        ...
        <div className="records-section">
          {records.length === 0 ? (
            <div className="empty-state">
              ...
              <p>
                Your medical records will appear here once your doctor uploads
                them
              </p>
            </div>
          ) : (
